...
function Bots({ selected, onSelect }: { selected: string; onSelect: (profile: ProfileInfo) => void }) {
  ...
  return <section className="command-center">
    <header className="command-header"><div className="brand-lockup"><span className="brand-orbit">⌁</span><div><p className="eyebrow">HERMES</p><strong>Operators</strong></div></div><span className="live-pill"><i /> {ready.length} online</span></header>
    <div className="command-intro"><p className="eyebrow">YOUR AGENTS</p><h1>Who’s on call?</h1><p>Choose an operator to continue the conversation.</p></div>
